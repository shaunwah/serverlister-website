...
<div class="card {{ (!$loop->last ? 'mb-3' : '') }} {{ (@$server->pings->last()->status == true ? 'shift-server-card-online' : 'shift-server-card-offline') }} {{ (isset($theme) ? 'bg-dark text-white shadow-none' : '' ) }}">
