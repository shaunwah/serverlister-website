        ...
        <div class="col-md-3 mb-3 mb-md-0">
            <div class="card">
                <ul class="list-group list-group-flush">
                    <a href="/user/settings/account" class="list-group-item list-group-item-action"><i class="fal fa-user fa-fw"></i> {{ __('components.user.headers.account') }}</a>
                    <a href="/user/settings/security" class="list-group-item list-group-item-action active"><i class="fal fa-lock fa-fw"></i> {{ __('components.user.headers.security') }}</a>
{{--                     <a href="#" class="list-group-item list-group-item-action disabled"><i class="fal fa-receipt fa-fw"></i> Billing</a>
        ...
        <div class="col-md-9">
            <form method="post" action="{{ url('user/settings/security') }}">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">{{ __('components.user.headers.security') }}</h5>
