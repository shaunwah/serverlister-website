...
@endsection
@section('title', __('servers.actions.create') . ' - ' . __('servers.server'))
@section('content')
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <h1 class="font-weight-bold">{{ __('servers.text.headers.create') }}</h1>
...
{{--                         <a href="{{ url('//guides.github.com/features/mastering-markdown/#examples') }}" target="_blank">Markdown</a> --}}
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <button type="submit" class="btn btn-success btn-block">{{ __('servers.text.input.create_button') }}</button>
                    </div>
                </div>
            </form>
        </div>
