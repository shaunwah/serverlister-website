    ...
    <div class="card mb-3" style="min-height:32rem;">
        <div class="card-body">
            ...
            <h2 class="d-none d-md-block display-3 text-muted" id="card-rank">
                <sup><i class="fal fa-hashtag fa-xs fa-fw"></i></sup>{{ number_format($server->rank) }}
            </h2>
            <ul class="list-inline mb-1">
                @if ($server->pings->last()->status)
                    <li class="list-inline-item">
                        <span class="font-weight-bold">{{ __('Players') }}</span>&nbsp; {{ number_format($server->pings->last()->players_current) }}
                ...
                <li class="list-inline-item"><span class="font-weight-bold">
                    {{ __('Votes') }}</span>&nbsp; {{ number_format($voteCountThisMonth) }}
                </li>
            </ul>
            <hr>
            <div class="row">
