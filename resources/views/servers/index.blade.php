...
<div class="container">
    <div class="row align-items-center">
        <div class="col-auto mr-auto">
            @isset($filters)
                <a class="text-decoration-none" href="{{ route('servers.index') }}"><i class="fal fa-chevron-left fa-fw"></i> All Servers</a>
            @endisset
            <h1 class="font-weight-bold">
                {{ __('Servers') }}
                @isset($filters)
                    <small class="text-muted">{{ __('in') . ' ' . $filtered->name }}</small>
                @endisset
            </h1>
        </div>
        <div class="col-auto">
